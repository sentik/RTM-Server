...
namespace language
{
	...
	namespace player
	{
		...
		namespace biography
		{
			...
			{
				"Но главное-это наше семейное счастье, которое царило внутри очага. С виду хрупкий мальчишка,шатен с голубыми глазами. В школу пошел рано,мне было тогда всего лишь 6 лет. "
			};
			...
			{
				"\"Почему я решил уехать ? \"-задавался я с каждым днем этим вопросом. Но ответ прост-за лучшей жизнью, за особняками, машинами и девочками... И новая жизнь началась, но какова ..."
			};
