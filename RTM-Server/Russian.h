...
namespace language
{
	...
	namespace player
	{
		...
		namespace biography
		{
			const char familyPartOne[ 10 ][ 200 ] =
			{
				"Родился Я в славном, прекрасном городе - Sevilla, в одном из его районов - The Bronx. У меня было много друзей, с которыми я каждый день гулял во дворе."
			};

			const char familyPartTwo[ 10 ][ 200 ] =
			{
				"Однажды, возвращаясь с прогулки по парку, я захотел чего-то сладкого и поэтому, моя мама, решила зайти в магазин, который находился через дорогу от парка. "
			};
			const char familyPartThree[ 10 ][ 200 ] =
			{
				"Когда мы переходили дорогу, неожиданно, из-за поворота появилось авто белого цвета... Все случилось мельком... Я успел отскочить, но моя мама - нет..."
			};
			const char familyPartFour[ 10 ][ 200 ] =
			{
				"Закончив школу, я сразу же выбрал Политический Центр института и подал заявление.. Спустя  неделю получил положительный ответ, собрал вещи, попрощался с родными"
			};
			//-------------------------------------------------------------------------------------------
			const char familyMotherOne[10 ][200] = 
			{
				"Моя мать умерла по пути в больницу. На то время мне было всего-лишь 5 лет или 6 лет."
			};
			const char familyMotherTwo[ 10 ][ 200 ] =
			{
				"Моя мать умерла по пути в больницу. На то время мне было всего-лишь 5 лет или 6 лет."
			};
			const char familyMotherThree[ 10 ][ 200 ] =
			{
				"Моя мать умерла по пути в больницу. На то время мне было всего-лишь 5 лет или 6 лет."
			};
			//-------------------------------------------------------------------------------------------
			const char familyFatherOne[ 10 ][ 128 ] =
			{
				"Спустя 2 года, когда я уже пошел во второй класс, скончался и мой отец - работник местного паба.."
			};
			const char familyFatherTwo[ 10 ][ 128 ] =
			{
				"Спустя 2 года, когда я уже пошел во второй класс, скончался и мой отец - работник местного паба.."
			};
			const char familyFatherThree[ 10 ][ 128 ] =
			{
				"Спустя 2 года, когда я уже пошел во второй класс, скончался и мой отец - работник местного паба.."
			};
			//-------------------------------------------------------------------------------------------
			const char familyBrotheOne[ 10 ][ 200 ] =
			{
				"Через несколько лет после окончания учебы и упешной карьеры, я узнал о своем брате, который жил в штате San Andreas и решил его навестить спустя длительные годы ..."
			};
			const char familyBrotheTwo[ 10 ][ 200 ] =
			{
				"Через несколько лет после окончания учебы и упешной карьеры, я узнал о своем брате, который жил в штате San Andreas и решил его навестить спустя длительные годы ..."
			};
			const char familyBrotheThree[ 10 ][ 200 ] =
			{
				"Через несколько лет после окончания учебы и упешной карьеры, я узнал о своем брате, который жил в штате San Andreas и решил его навестить спустя длительные годы ..."
			};
			//-------------------------------------------------------------------------------------------
			const char familyPartFive[ 10 ][ 200 ] =
			{
				"Закончив школу, я сразу же выбрал Политический Центр института и подал заявление.. Спустя  неделю получил положительный ответ, собрал вещи, попрощался с родными"
			};
			const char familyPartSix[ 10 ][ 200 ] =
			{
				"Закончив школу, я сразу же выбрал Политический Центр института и подал заявление.. Спустя  неделю получил положительный ответ, собрал вещи, попрощался с родными"
			};
		}
